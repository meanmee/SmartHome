...
public class RecSettings {
    ...
    public static void voiceName(String voiceName_string) {
        CloudRec.mSpeechRec.setParameter(SpeechConstant.VOICE_NAME, voiceName_string);
    }

    //设置语速
    public static void voiceSpeed(String voiceSpeed_sring) {
        CloudRec.mSpeechRec.setParameter(SpeechConstant.SPEED, voiceSpeed_sring);
    }
    ...
    public static void audioSource(String audioSource_sring) {
        CloudRec.mSpeechRec.setParameter(SpeechConstant.AUDIO_SOURCE, audioSource_sring);
    }
